...
const DesignTokensDisplay = () => {
  ...
  const handleSearch = e => {
    ...
    const filtered = Object.keys(_merged_colors_json__WEBPACK_IMPORTED_MODULE_1__.color).reduce((acc, tokenName) => {
      if (tokenName.toLowerCase().includes(value.toLowerCase())) {
        acc[tokenName] = _merged_colors_json__WEBPACK_IMPORTED_MODULE_1__.color[tokenName];
      }
      return acc;
    }, {});
...
//# sourceMappingURL=DesignTokensDisplay-stories.f2d3afa52a553b8ba12b.hot-update.js.map